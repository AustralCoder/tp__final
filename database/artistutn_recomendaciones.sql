...
--
-- Host: localhost    Database: artistutn
-- ------------------------------------------------------
...
CREATE TABLE `recomendaciones` (
  `idReco` int NOT NULL AUTO_INCREMENT,
...
INSERT INTO `recomendaciones` VALUES (1,'Dias y flores','Silvio Rodriguez');
...
-- Dump completed on 2022-08-23 23:07:40
